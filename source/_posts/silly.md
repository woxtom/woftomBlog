...
我构建的“智障”链路（实际使用的就是这一套）：

1.  用户访问 VPS (端口8888) 
2.  **Down**: 隧道下行 -> 我的电脑 (端口9001)
3.  **Up**: 隧道上行 -> VPS (端口9002)
4.  **Down**: 隧道下行 -> 我的电脑 (端口9003)
5.  **Up**: 隧道上行 -> VPS (端口9004)
6.  **Down**: 隧道下行 -> 终于到达我的电脑 (端口3001 Web服务)

这就像是你点了外卖，外卖小哥到了你家楼下，又跑回商家，商家又让他送一次... 如此反复五次，最后才把饭给你送到门口。
## 工具链
